                            ...
                            <form method="post" action="signup">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input value="${results.email}" type="text" class="<c:if test="${not empty results.emailError}">is-invalid</c:if> form-control border-0 bg-light rounded-end ps-1" placeholder="E-mail" id="inputEmail1" name="inputEmail1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input value="${results.password1}" type="password" class="<c:if test="${not empty results.password1Error}">is-invalid</c:if> form-control border-0 bg-light rounded-end ps-1" placeholder="*********" id="inputPassword1" name="inputPassword1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="fas fa-lock"></i></span>
                                        <input value="${results.password2}" type="password" class="<c:if test="${not empty results.password2Error}">is-invalid</c:if> form-control border-0 bg-light rounded-end ps-1" placeholder="*********" id="inputPassword2" name="inputPassword2">
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        <input ${results.termsOfService == "agree" ? "checked" : ""} name="termsOfService" value="agree" type="checkbox" class="<c:if test="${not empty results.termsOfServiceError}">is-invalid</c:if> form-check-input" id="checkbox-1">
